...
provider "github" {
  # Configuration options
  token = "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"
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  user_data = <<-EOF
          ...
          TOKEN="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"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/cemilekaplan/bookstore-repo/main/"
          ...
          docker build -t cemilekaplan/bookstoreapi:latest .
          docker-compose up -d
          EOF
